var erc721MetadataImplementation = artifacts.require('ERC721MetadataImplementation');

contract('erc721MetadataImplementation', accounts => {
    ...
    describe('match erc721 spec', function () {
        beforeEach(async function () {
            this.contract = await erc721MetadataImplementation.new({from: account_one});
